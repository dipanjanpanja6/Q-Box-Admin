            ...
            <SvgIcon style={{ height: 50, width: 50 }}>
              <svg viewBox="0 0 485.075 485.076">
                <defs>
                  <clipPath id="clip-path">
                    <rect
                      ...
                      height="343"
                      rx="47"
                      transform="translate(717 577.795) rotate(-45)"
                      fill="#008c9e"
                    />
                  </clipPath>
                  <radialGradient
                    ...
                    cy="0.017"
                    r="1.105"
                    gradientTransform="matrix(-0.18, 0.984, -2.541, -0.466, 0.928, -0.714)"
                ...
                <g
                  ...
                  transform="translate(10807 15148)"
                >
                  <g
                    id="Group_8036"
                    data-name="Group 8036"
                    transform="translate(395 -384)"
                  >
                    <g
                      id="Group_8031"
                    ...
                    >
                      <g
                        ...
                        transform="translate(-11913 -15062)"
                      >
                        <g
                          id="Mask_Group_7642"
                          data-name="Mask Group 7642"
                          transform="translate(0 -39.256)"
                          clipPath="url(#clip-path)"
                        >
                          <g
                            id="Group_7900"
                            data-name="Group 7900"
                            transform="translate(288.6 806.8)"
                            opacity="0"
                          >
                            <path
                              id="Path_1940"
                              data-name="Path 1940"
                              d="M-22262.424-15210.229s-67.6-320-150.3-320-133.031,72.727-225.453,72.727-130.91,230.3-130.91,230.3l20.689,543.6h458.8Z"
                              transform="translate(23190.4 14994.2)"
                          ...
                          <path
                            id="Path_2779"
                            data-name="Path 2779"
                            d="M182,0A182,182,0,1,1,0,182,182,182,0,0,1,182,0Z"
                            transform="translate(853 484.256)"
                            fill="rgba(129,103,242,0.7)"
                          />
                          <path
                            id="Path_2780"
                            data-name="Path 2780"
                            d="M185.433,0C287.845,0,370.866,83.021,370.866,185.433S287.845,370.866,185.433,370.866,0,287.845,0,185.433,83.021,0,185.433,0Z"
                            transform="translate(650.134 349.39)"
                        ...
                        <g
                          ...
                          transform="translate(717 538.537) rotate(-45)"
                          fill="none"
                          stroke="#fff"
                          strokeWidth="3"
                        >
